    ...
    <main className="auth-page">
      ...
      <div className="auth-layout">
        <section className="auth-story" aria-labelledby="auth-story-title">
          <Link className="auth-brand" href="/entrar" aria-label="Wise, ir para entrar">
        ...
        <section className="auth-form-panel" aria-label="Formulário de autenticação">
          <div className="auth-card">
            ...
            <div className="auth-form"><div><h2 className="auth-form__intro">Abra seu grimório</h2><p className="auth-form__subintro">Seus registros de foco aguardam por você.</p></div>{children}</div>
